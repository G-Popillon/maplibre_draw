...
//           map.setLayoutProperty(uuid + 'area', 'visibility', 'none')
//         }
//         map.setLayoutProperty(uuid + 'point', 'visibility', 'none')
//         //---------------------------是否平滑处理---------------------------//
//         if (smooth) {
...
//           function generateCardinalSplinePoints(points: string | any[], tension: number, numOfSegments: number) {
//             const splinePoints = []
...
//           // // Generate the Cardinal Spline points
//           // const arr = [...point, point[0]]
//           // const splinePoints = generateCardinalSplinePoints(arr, tension, 50)

//           // // Output the spline points to the console
//           // console.log(splinePoints, 'splinePoints')
//           //---------------------------上面是新方法 针对点少的多边形 平滑处理---------------------------//
//           // return

//           const newPoints = [...point, point[0]]
//           // 将点数组分成N个子数组
//           // const len = newPoints.length > 4 ? 5 : 2
//           const len = newPoints.length > 5 ? 4 : 2
//           // const len = 1
...
//           console.log(bezierPoints, 'bezierPointsbezierPointsbezierPoints')
//           json_polygon.geometry.coordinates[0].length = 0
//           for (let i = 0; i < bezierPoints.length; i++) {
//             const point = map.unproject(bezierPoints[i] as any)
